...
<div id="contact" class="fixed inset-0 z-10 hidden">
	<a href="#main" class="fixed inset-0 bg-black/75 visually__hidden__link">
		Close contact form
	</a>
	<div class="w-[1024px] bg-card flex relative border-forground/10 border">
