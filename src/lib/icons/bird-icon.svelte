<script lang="ts">
	...
	const { ...rest }: SVGAttributes<EventTarget> = $props();
</script>

<svg width="24" height="24" viewBox="0 0 60.4 57.4" {...rest}>
	<g
		transform="matrix(0.7543103448275862,0,0,0.7543103448275862,-7.5430984127110445,-9.051678098481277)"
	>
